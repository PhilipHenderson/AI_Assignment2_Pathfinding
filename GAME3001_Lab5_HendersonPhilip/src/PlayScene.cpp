...
void PlayScene::handleEvents()
{
	...
	if(EventManager::Instance().isKeyDown(SDL_SCANCODE_F))
	{
		m_findShortestPath();
		//show pathcost
		float distance(glm::vec2 m_pShip, glm::vec2 m_pTarget);
		m_pInstructionsLabel = new Label("Shortest Path", "Consolas", 20, blue, glm::vec2(400.0f, 50.0f));
...
void PlayScene::start()
{
	...
	m_pInstructionsLabel = new Label("Press F to Find Shortest Path", "Consolas", 20, blue, glm::vec2(400.0f, 500.0f));
	m_pInstructionsLabel->setParent(this);
	addChild(m_pInstructionsLabel);
	m_pInstructionsLabel = new Label("Press R to Reset (not complete)", "Consolas", 20, blue, glm::vec2(400.0f, 520.0f));
	m_pInstructionsLabel->setParent(this);
	addChild(m_pInstructionsLabel);
	m_pInstructionsLabel = new Label("Press M to Make Ship Follow Shortest Path", "Consolas", 20, blue, glm::vec2(400.0f, 540.0f));
	m_pInstructionsLabel->setParent(this);
	addChild(m_pInstructionsLabel);
...
void PlayScene::m_buildGrid()
{
	...
	for (int row = 0; row < Config::ROW_NUM; ++row)
	{
		for (int col = 0; col < Config::COL_NUM; ++col)
		{
			...
			//if tile 1,3 1,4 1,5 mark as CLOSED
			if (tile)
